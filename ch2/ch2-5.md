...
> http://192.168.1.233/API/V2/real?deviceCodes=["system","IO-30S-BM","NCE-01"] (192.168.1.233为需要查询的网关的ip地址，["system","IO-30S-BM","NCE-01"]为需要获取数据的设备名称数组)
...
[
    ...
    },
    {
        ...
        "val": [
            {
                "id": "NCE-01.NCE-01/Energy.MV1",
                "status": "Good",
                "val": "1.000000",
                "timestamp": 1566281009
            },
            {
                "id": "NCE-01.NCE-01/Energy.MV2",
                "status": "Good",
                "val": "1.000000",
                "timestamp": 1566281009
            }
